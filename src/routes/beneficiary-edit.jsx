        ...
        <div className='column is-8 is-offset-2 my-6'>
            ...
            <form onSubmit={handleSubmit}>
                <div className='columns is-multiline'>
                    ...
                    <FormInput required disabled type="email" id="emailAddress" value={emailAddress} onChange={handleChange} label="Email Address *" additionalClasses="column is-6"/>
