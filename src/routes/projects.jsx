...
const Projects = () => {
    ...
    useEffect(() => {
        async function getDocs() {
            const docs = await getProjectDocuments(status, municipality, barangay);
            setProjects(docs);
        };
        getDocs();
    }, [formFields, status]);
    ...
    return (
        ...
        <div className="columns is-vcentered">
            <h2 className='is-size-4 has-text-weight-bold column is-6'>{status.charAt(0).toUpperCase() + status.substring(1).toLowerCase()} Projects</h2>
