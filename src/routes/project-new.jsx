...
import { createProjectDocument } from '../utils/firebase';
...
const ProjectNew = () => {
    ...
    const { province, municipality, barangay, district, title, beneficiaries, budget, days } = formFields;
    ...
    const handleSubmit = async (event) => {
        ...
        const response = await createProjectDocument(formFields);
        ...
        <div className='column is-8 is-offset-2 my-6'>
            ...
            <form onSubmit={handleSubmit}>
                <div className='columns is-multiline'>
                    ...
                    <FormInput type="number" required id="beneficiaries" value={beneficiaries} onChange={handleChange} label="Number of Beneficiaries" additionalClasses="column is-3"/>
